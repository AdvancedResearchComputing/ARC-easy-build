# EasyBuild at Advanced Research Computing at Virginia Tech
(page created with inspiration from https://fredhutch.github.io/easybuild-life-sciences/)
---

## Overview
- Advanced Research Computing uses Easybuild to provide 100s of OSS packages to our Scientists
...
Please open an issue against this repo to request new softwares or www.arc.vt.edu > requests > help.
...
- find find your module

```
module spider R
```

- choose the module you want from the list of module matching the search and load:

```
module load foss/R/4.0.2
```
...
[Easybuild packages available at the ARC](https://arc.github.io/ARC-easybuild/)

Github pages documentation is maintained for HPC users at ARC.
